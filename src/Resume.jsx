...
const Resume = () => {
  ...
  const portfolioLinks = [
    ...
    {
      name: 'DeviantArt',
      url: 'https://www.deviantart.com/catbosstw',
      icon: <Image size={16} />,
      ...
      <div className="main-content">
          ...
          <div className="section">
            ...
            <div className="skill-category">
              ...
              <div className="skill-grid">
                ...
                <span className="skill-item">asp</span>
                <span className="skill-item">Git 版本控制</span>
                <span className="skill-item">Figma 設計轉前端</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="content">
          ...
          <div className="section">
            ...
            <div className="experience-item">
              <div className="job-header">
                <div>
                  ...
                  <p className="company">子佳國際</p>
                </div>
                <span className="job-period">2021/05 - 2021/07</span>
              </div>
              <p className="job-description">
                美工與產品加工圖設計
              </p>
            ...
            <div className="experience-item">
              <div className="job-header">
                <div>
                  <h3 className="job-title">美術兼網站設計</h3>
                  <p className="company">尊榮旅行社/躍龍門留學有限公司</p>
                </div>
                <span className="job-period">2017/07 - 2019/12</span>
              </div>
              <p className="job-description">
                網站美編設計與 SEO 優化管理
              </p>
              <ul className="highlights">
                <li>旅遊與留學公司網站視覺設計與維護</li>
                <li>SEO 優化策略執行，提升網站流量</li>
                <li>IT管理與前端網頁HTML/CSS/RWD維護</li>
              </ul>
            </div>
          </div>
          ...
          <div className="ai-highlight">
            ...
            <p>
              2025 年 10 月結訓 - 參加政府產業新尖兵職訓課程學習前端開發，
              希望結合豐富的設計背景與新習得的程式技能，成為具備視覺美感的前端工程師，
              期待在穩定的工作環境中發揮創意，同時持續精進技術能力，為團隊帶來設計思維的價值
            </p>
            <p>
              2026 年 7 月結訓 - 參加政府永續AI智慧品質管理職訓課程學習永續發展與數位應用趨勢，
              希望結合前端開發與永續理念，打造符合現代需求的數位產品，
              期望在職場中能夠運用所學，推動企業的永續發展與數位轉型，
              AI輔助工具的應用也將成為我未來工作中的重要技能，提升工作效率與創新能力
            </p>
          </div>
        </div>
      </div>
